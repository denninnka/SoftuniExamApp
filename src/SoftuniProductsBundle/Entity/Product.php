...
class Product
{
     ...
     * @ORM\JoinTable("products_categories")
     */
    ...
    {
        if (!$this->productsCategories->contains($productCategory)){
            $productCategory->addProduct($this);
            $this->productsCategories->add($productCategory);
        }
    }
    ...
    {
        if ($this->productsCategories->contains($productCategory)){
            $this->productsCategories->removeElement($productCategory);
        }
    }
}
